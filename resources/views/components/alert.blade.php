<div>
    <div id="alert-2" @class([
        'max-w-7xl mx-auto flex items-center p-4 mb-4',
        'text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400' =>
            $alertType == 'error',
        'text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 border border-green-300 dark:border-green-800' =>
            $alertType == 'success',
    ]) role="alert">
